...
# 결론
지금까지 기계학습과 파이썬으로 구현된 scikit-learn을 간략하게 살펴봤고 붓꽃 예제에 적용했다. 기계 학습에는 다양한 기법이 있고 여기에서 다루지 않은 적용된 기법에 대한 평가에 문제가 있다. scikit-learn은 문서화가 매우 잘 돼있어 기계 학습 기법을 학습한 후 scikit-learn 문서를 찾아 보면 그리 어렵지 않게 실제 문제에 적용할 수 있다. 마지막으로 실행 가능한 소스는 https://github.com/brenden17/iris 에서 볼 수 있다.
